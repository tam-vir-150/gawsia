...
export default function Home() {
  ...
  return (
    <div className="w-full h-[110%] p-6 bg-white flex flex-col items-center">
      ...
      <ProductCard title={"Single Jersey Machines"} description={descriptions.product1.substring(0, 243) + "..."} bg={"/p3.jpg"}/>
      </div>
      <div className="w-full h-full p-6 flex flex-col items-center justify-center">
        <ProductCard title={"Double Jersey Machines"} description={descriptions.product2.substring(0, 225) + "..."} bg={"/p1.jpg"}/>
      </div>
      <div className="w-full h-full p-6 flex flex-col items-center justify-center">
      <ProductCard title={"Electronic Jacquard Machines"} description={descriptions.product3.substring(0, 228) + "..."} bg={"/p2.jpg"}/>
      </div>
